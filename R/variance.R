...
#
  ...
  # TODO: this method is known to be numerically unstable, so it should
  # be replaced in future versions of this package
  moment(x, 2) - moment(x, 1) ^ 2  # use Steiner's theorem
}
